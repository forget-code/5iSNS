...
include $conf['view_path'].'thread-list.html';
...
if($userqx['quanxian_limit_topic']>0){
	...
	if($method == 'GET') {
		...
		include $conf['view_path'].'thread-create.html';
...
send_message($value,$subject,$mail_subject,'new_user_content');
...
$pagination = pagination(r_url('thread-'.$id, array('page' => 'pagenum')), $totalnum, $page, $pagenum);
    ...
    include $conf['view_path'].'thread-con.html';
}
